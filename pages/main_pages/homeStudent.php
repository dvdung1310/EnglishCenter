                            ...
                            <div class="course-slide">
                                <div class="slider-for-course courseSlider">
                                    <div class="courseSlidler-item">
                                        <img class="img-inner" src="../../assets/images/course-1.jpg" />
                                    </div>
                                    <div class="courseSlidler-item">
                                        <img class="img-inner" src="../../assets/images/course-2.jpg" />
                                    </div>
                                    <div class="courseSlidler-item">
                                        <img class="img-inner" src="../../assets/images/course-3.jpg" />
                                    </div>
                                    <div class="courseSlidler-item">
                                        <img class="img-inner" src="../../assets/images/course-4.jpg" />
                                    </div>
                                </div>
