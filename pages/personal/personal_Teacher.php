...
$jsaccountTeacher = json_encode($accountTeacher);
        ...
        <div class="personal-inner">
            ...
            <div class="personal-inner-info">
                ...
                <form action="" method="POST" id='form-update'>
                    ...
                    <div class="personal-inner-item">
                        <div class="personal-inner-key">Quê quán : <strong style="color: red; font-size: 12px;font-style: italic;" id="err-hometown"></strong></div>
                        <div id="hometown" class="personal-inner-value personal-inner-value-info">Hà nội</div>
                    </div>
                    <input id="hometown-input" name="hometown-input" class="personal-inner-edit-range personal-inner-edit-range-info" type="tetxt" placeholder="Nhập quê quán" required></input>
                    ...
                    <div class="personal-inner-item">
                        <div class="personal-inner-key">Trình dộ : <strong style="color: red; font-size: 12px;font-style: italic;" id="err-qualification"></strong></div>
                        <div id="qualification" class="personal-inner-value personal-inner-value-info">Longabc@gmail.com</div>
                    </div>
                    <input id="qualification-input" name="qualification-input" class="personal-inner-edit-range personal-inner-edit-range-info" type="tetxt" placeholder="Nhập trình độ" required></input>
...
<script>
    ...
    submit_update.addEventListener('click', function(event) {
        ...
        if (!hometown) {
            ...
            document.getElementById('err-hometown').textContent = erorr_empty;
            check = false;
        } else
            document.getElementById('err-hometown').textContent = "";
        ...
        if (!qualification) {
            ...
            document.getElementById('err-qualification').textContent = erorr_empty;
            check = false;
        } else
            document.getElementById('err-qualification').textContent = "";
